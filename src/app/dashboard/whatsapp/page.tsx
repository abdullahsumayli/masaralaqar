                                                        ...
                                                        {/* Phone number input */}
                                                                        <div>
                                                                                            ...
                                                                                            <input
                                                                                                                  ...
                                                                                                                  />
                                                                          {phoneError ? (
                                                              <p className="text-red-400 text-xs mt-1">{phoneError}</p>p>
                                                            ) : (
                                                        ...
                                                        {[
                                                            ...
                                                            "امسح رمز QR الذي سيظهر",
                                                                        ...
                                                                        <li className="flex gap-3 items-start">
                                                                                            ...
                                                                                            <span>يتم الربط تلقائياً وتفعيل الرد الذكي</span>span>
                                                                        </li>li>
                                                      </ol>ol>
                                      </div>div>
                        </motion.div>motion.div>
                        ...
                        <motion.div
                          ...
                          {!qrExpired && (
                                                        <div className="flex items-center justify-center gap-2 text-yellow-400">
                                                                          ...
                                                                          <span className="text-sm">بانتظار مسح QR Code...</span>span>
                                                        </div>div>
                                      )}
                                                        ...
                                                        {/* Connection status */}
                                                                        <div className="flex items-center gap-3 p-4 rounded-lg bg-surface">
                                                                                            ...
                                                                                            <div className="flex-1">
                                                                                                                  ...
                                                                                                                  <p className="text-[#25D366] text-xs">متصل</p>p>
                                                                                              </div>div>
