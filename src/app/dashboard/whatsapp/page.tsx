...
> = {
  connected: { label: "متصل", color: "text-green-400", icon: Wifi },
  disconnected: { label: "غير متصل", color: "text-red-400", icon: WifiOff },
  pending: { label: "قيد الربط", color: "text-yellow-400", icon: Circle },
  expired: { label: "منتهي", color: "text-gray-400", icon: WifiOff },
};
...
export default function WhatsAppPage() {
  ...
  const statusInfo = statusLabels[statusKey] || statusLabels.disconnected;
