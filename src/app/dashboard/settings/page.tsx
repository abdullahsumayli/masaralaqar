    ...
    <div className="min-h-full bg-surface">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="bg-background rounded-xl border border-border p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-medium text-text-secondary mb-1.5">
                <span className="flex items-center gap-1.5">
                  <Building2 className="w-4 h-4" /> اسم المكتب / الشركة
                </span>
              </label>
              <input
                type="text"
          ...
          {message && (
            <div
              className={`flex items-center gap-2 mt-4 text-sm ${message.type === "success" ? "text-green-500" : "text-red-500"}`}
            >
        ...
        <section className="bg-background rounded-xl border border-border p-6">
          ...
          {passwordMessage && (
            <div
              className={`flex items-center gap-2 mt-4 text-sm ${passwordMessage.type === "success" ? "text-green-500" : "text-red-500"}`}
            >
