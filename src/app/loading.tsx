    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="h-16 md:h-20 border-b border-border bg-background/80 backdrop-blur-lg">
        <div className="container-custom flex items-center justify-between h-full">
          ...
          <div className="hidden md:flex items-center gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="w-16 h-4 rounded bg-gray-200 animate-pulse" />
            ))}
          </div>
      ...
      <div className="pt-20 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="w-48 h-8 rounded-full bg-gray-200 animate-pulse mx-auto" />
          <div className="w-full max-w-xl h-12 rounded-lg bg-gray-200 animate-pulse mx-auto" />
          <div className="w-full max-w-lg h-6 rounded bg-gray-200 animate-pulse mx-auto" />
