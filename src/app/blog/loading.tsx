    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-20 px-4 bg-surface border-b border-border">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="w-24 h-6 rounded-full bg-gray-200 animate-pulse mx-auto" />
          <div className="w-64 h-10 rounded-lg bg-gray-200 animate-pulse mx-auto" />
          <div className="w-80 h-5 rounded bg-gray-200 animate-pulse mx-auto" />
        </div>
      </div>
