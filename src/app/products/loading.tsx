    ...
    <div className="min-h-screen bg-background">
      <div className="pt-24 pb-16 px-4 bg-surface border-b border-border">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <div className="w-80 h-12 rounded-lg bg-[#162444] animate-pulse mx-auto" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="space-y-6">
            <div className="w-40 h-6 rounded bg-[#162444] animate-pulse" />
            <div className="grid md:grid-cols-3 gap-5">
              {[...Array(3)].map((_, j) => (
                <div key={j} className="border border-border rounded-2xl p-6 space-y-4">
                  <div className="w-12 h-12 rounded-xl bg-[#162444] animate-pulse" />
                  <div className="w-32 h-5 rounded bg-[#162444] animate-pulse" />
